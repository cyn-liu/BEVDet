...
class BEVStage(torch.nn.Module):
    def __init__(self, img_bev_encoder_backbone=None, img_bev_encoder_neck=None, pts_bbox_head=None, **kwargs):
...
class BEVModel(Base3DDetector):
    def __init__(self,                
        ...
        self.bev_encoder = BEVStage(img_bev_encoder_backbone, img_bev_encoder_neck, pts_bbox_head)
